...
public class CreateCurrencyRequest {
  ...
  public CreateCurrencyRequest rate(Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  **/
  ...
  public CreateCurrencyRequest shortName(String shortName) {
  ...
  **/
  ...
  public CreateCurrencyRequest description(String description) {
  ...
  **/
  ...
  public CreateCurrencyRequest unicodeSign(String unicodeSign) {
  ...
  **/
  ...
  public CreateCurrencyRequest htmlSign(String htmlSign) {
  ...
  **/
  ...
  public CreateCurrencyRequest currencySourceId(Integer currencySourceId) {
  ...
  **/
  ...
  public CreateCurrencyRequest feDecimals(Integer feDecimals) {
  ...
  **/
  ...
  public CreateCurrencyRequest isBeforeSign(Boolean isBeforeSign) {
  ...
  **/
  ...
  public CreateCurrencyRequest allowDecimals(Boolean allowDecimals) {
  ...
  **/
  ...
  public CreateCurrencyRequest displayFormat(CurrencyDisplay displayFormat) {
  ...
  **/
  ...
  public CreateCurrencyRequest currencyId(Integer currencyId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rate, createCurrencyRequest.rate) &&
        Objects.equals(this.shortName, createCurrencyRequest.shortName) &&
        Objects.equals(this.description, createCurrencyRequest.description) &&
        Objects.equals(this.unicodeSign, createCurrencyRequest.unicodeSign) &&
        Objects.equals(this.htmlSign, createCurrencyRequest.htmlSign) &&
        Objects.equals(this.currencySourceId, createCurrencyRequest.currencySourceId) &&
        Objects.equals(this.feDecimals, createCurrencyRequest.feDecimals) &&
        Objects.equals(this.isBeforeSign, createCurrencyRequest.isBeforeSign) &&
        Objects.equals(this.allowDecimals, createCurrencyRequest.allowDecimals) &&
        Objects.equals(this.displayFormat, createCurrencyRequest.displayFormat) &&
        Objects.equals(this.currencyId, createCurrencyRequest.currencyId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateCurrencyRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCurrencyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCurrencyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCurrencyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
