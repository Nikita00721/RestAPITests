...
/**
 * AddGoldenBoostItemRequest
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-26T23:02:24.556418400+03:00[Europe/Moscow]")
public class AddGoldenBoostItemRequest {
  ...
  public AddGoldenBoostItemRequest() {
  }

  public AddGoldenBoostItemRequest selectionTypeId(Integer selectionTypeId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest specialOddsValue(String specialOddsValue) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest selectionId(Long selectionId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest selectionName(String selectionName) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest marketName(String marketName) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest ladderTypeId(LadderTypes ladderTypeId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest isLimitedTime(Boolean isLimitedTime) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest offerStartTime(Integer offerStartTime) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest offerEndTime(Integer offerEndTime) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest isAutoUpdate(Boolean isAutoUpdate) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest limitType(BoostLimitType limitType) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest stakeLimitFactor(Double stakeLimitFactor) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest winLimitFactor(Double winLimitFactor) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest boostLimitId(Integer boostLimitId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest boostMethod(BoostItemMethod boostMethod) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest fmConfigId(Integer fmConfigId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest boostConfigId(Integer boostConfigId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest eventId(Long eventId) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest boostFactor(Double boostFactor) {
  ...
  **/
  ...
  public AddGoldenBoostItemRequest marketTypeId(Integer marketTypeId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddGoldenBoostItemRequest addGoldenBoostItemRequest = (AddGoldenBoostItemRequest) o;
    return Objects.equals(this.selectionTypeId, addGoldenBoostItemRequest.selectionTypeId) &&
        Objects.equals(this.specialOddsValue, addGoldenBoostItemRequest.specialOddsValue) &&
        Objects.equals(this.selectionId, addGoldenBoostItemRequest.selectionId) &&
        Objects.equals(this.selectionName, addGoldenBoostItemRequest.selectionName) &&
        Objects.equals(this.marketName, addGoldenBoostItemRequest.marketName) &&
        Objects.equals(this.ladderTypeId, addGoldenBoostItemRequest.ladderTypeId) &&
        Objects.equals(this.isLimitedTime, addGoldenBoostItemRequest.isLimitedTime) &&
        Objects.equals(this.offerStartTime, addGoldenBoostItemRequest.offerStartTime) &&
        Objects.equals(this.offerEndTime, addGoldenBoostItemRequest.offerEndTime) &&
        Objects.equals(this.isAutoUpdate, addGoldenBoostItemRequest.isAutoUpdate) &&
        Objects.equals(this.limitType, addGoldenBoostItemRequest.limitType) &&
        Objects.equals(this.stakeLimitFactor, addGoldenBoostItemRequest.stakeLimitFactor) &&
        Objects.equals(this.winLimitFactor, addGoldenBoostItemRequest.winLimitFactor) &&
        Objects.equals(this.boostLimitId, addGoldenBoostItemRequest.boostLimitId) &&
        Objects.equals(this.boostMethod, addGoldenBoostItemRequest.boostMethod) &&
        Objects.equals(this.fmConfigId, addGoldenBoostItemRequest.fmConfigId) &&
        Objects.equals(this.boostConfigId, addGoldenBoostItemRequest.boostConfigId) &&
        Objects.equals(this.eventId, addGoldenBoostItemRequest.eventId) &&
        Objects.equals(this.boostFactor, addGoldenBoostItemRequest.boostFactor) &&
        Objects.equals(this.marketTypeId, addGoldenBoostItemRequest.marketTypeId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(selectionTypeId, specialOddsValue, selectionId, selectionName, marketName, ladderTypeId, isLimitedTime, offerStartTime, offerEndTime, isAutoUpdate, limitType, stakeLimitFactor, winLimitFactor, boostLimitId, boostMethod, fmConfigId, boostConfigId, eventId, boostFactor, marketTypeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddGoldenBoostItemRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AddGoldenBoostItemRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddGoldenBoostItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGoldenBoostItemRequest is not found in the empty JSON string", AddGoldenBoostItemRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddGoldenBoostItemRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddGoldenBoostItemRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGoldenBoostItemRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGoldenBoostItemRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGoldenBoostItemRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGoldenBoostItemRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGoldenBoostItemRequest>() {
           @Override
           public void write(JsonWriter out, AddGoldenBoostItemRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddGoldenBoostItemRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddGoldenBoostItemRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGoldenBoostItemRequest
  * @throws IOException if the JSON string is invalid with respect to AddGoldenBoostItemRequest
  */
  public static AddGoldenBoostItemRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGoldenBoostItemRequest.class);
  }

 /**
  * Convert an instance of AddGoldenBoostItemRequest to an JSON string
  *
  * @return JSON string
  */
