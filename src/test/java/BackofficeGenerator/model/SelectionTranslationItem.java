...
/**
 * SelectionTranslationItem
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-26T23:02:24.556418400+03:00[Europe/Moscow]")
public class SelectionTranslationItem {
  ...
  public SelectionTranslationItem() {
  }

  public SelectionTranslationItem languageName(String languageName) {
  ...
  **/
  ...
  public SelectionTranslationItem internalTranslation(String internalTranslation) {
  ...
  **/
  ...
  public SelectionTranslationItem internalDescription(String internalDescription) {
  ...
  **/
  ...
  public SelectionTranslationItem globalTranslation(String globalTranslation) {
  ...
  **/
  ...
  public SelectionTranslationItem globalDescription(String globalDescription) {
  ...
  **/
  ...
  public SelectionTranslationItem customTranslation(String customTranslation) {
  ...
  **/
  ...
  public SelectionTranslationItem customDescription(String customDescription) {
  ...
  **/
  ...
  public SelectionTranslationItem isUnfinished(Boolean isUnfinished) {
  ...
  **/
  ...
  public SelectionTranslationItem inheritanceType(Integer inheritanceType) {
  ...
  **/
  ...
  public SelectionTranslationItem languageId(Integer languageId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SelectionTranslationItem selectionTranslationItem = (SelectionTranslationItem) o;
    return Objects.equals(this.languageName, selectionTranslationItem.languageName) &&
        Objects.equals(this.internalTranslation, selectionTranslationItem.internalTranslation) &&
        Objects.equals(this.internalDescription, selectionTranslationItem.internalDescription) &&
        Objects.equals(this.globalTranslation, selectionTranslationItem.globalTranslation) &&
        Objects.equals(this.globalDescription, selectionTranslationItem.globalDescription) &&
        Objects.equals(this.customTranslation, selectionTranslationItem.customTranslation) &&
        Objects.equals(this.customDescription, selectionTranslationItem.customDescription) &&
        Objects.equals(this.isUnfinished, selectionTranslationItem.isUnfinished) &&
        Objects.equals(this.inheritanceType, selectionTranslationItem.inheritanceType) &&
        Objects.equals(this.languageId, selectionTranslationItem.languageId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(languageName, internalTranslation, internalDescription, globalTranslation, globalDescription, customTranslation, customDescription, isUnfinished, inheritanceType, languageId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SelectionTranslationItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SelectionTranslationItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SelectionTranslationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SelectionTranslationItem is not found in the empty JSON string", SelectionTranslationItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SelectionTranslationItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SelectionTranslationItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelectionTranslationItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelectionTranslationItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelectionTranslationItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelectionTranslationItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SelectionTranslationItem>() {
           @Override
           public void write(JsonWriter out, SelectionTranslationItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SelectionTranslationItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SelectionTranslationItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelectionTranslationItem
  * @throws IOException if the JSON string is invalid with respect to SelectionTranslationItem
  */
  public static SelectionTranslationItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelectionTranslationItem.class);
  }

 /**
  * Convert an instance of SelectionTranslationItem to an JSON string
  *
  * @return JSON string
  */
