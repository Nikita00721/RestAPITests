...
public class AamsEventInfo {
  ...
  public AamsEventInfo() {
  }

  public AamsEventInfo operatorName(String operatorName) {
  ...
  **/
  ...
  public AamsEventInfo intEventId(Long intEventId) {
  ...
  **/
  ...
  public AamsEventInfo extEventId(String extEventId) {
  ...
  **/
  ...
  public AamsEventInfo eventName(String eventName) {
  ...
  **/
  ...
  public AamsEventInfo processedStatus(Integer processedStatus) {
  ...
  **/
  ...
  public AamsEventInfo processedStatusName(String processedStatusName) {
  ...
  **/
  ...
  public AamsEventInfo processedMessage(String processedMessage) {
  ...
  **/
  ...
  public AamsEventInfo eventType(Integer eventType) {
  ...
  **/
  ...
  public AamsEventInfo registeredEventId(Long registeredEventId) {
  ...
  **/
  ...
  public AamsEventInfo aamsEventDate(OffsetDateTime aamsEventDate) {
  ...
  **/
  ...
  public AamsEventInfo intEventDate(OffsetDateTime intEventDate) {
  ...
  **/
  ...
  public AamsEventInfo operatorId(Integer operatorId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AamsEventInfo aamsEventInfo = (AamsEventInfo) o;
    return Objects.equals(this.operatorName, aamsEventInfo.operatorName) &&
        Objects.equals(this.intEventId, aamsEventInfo.intEventId) &&
        Objects.equals(this.extEventId, aamsEventInfo.extEventId) &&
        Objects.equals(this.eventName, aamsEventInfo.eventName) &&
        Objects.equals(this.processedStatus, aamsEventInfo.processedStatus) &&
        Objects.equals(this.processedStatusName, aamsEventInfo.processedStatusName) &&
        Objects.equals(this.processedMessage, aamsEventInfo.processedMessage) &&
        Objects.equals(this.eventType, aamsEventInfo.eventType) &&
        Objects.equals(this.registeredEventId, aamsEventInfo.registeredEventId) &&
        Objects.equals(this.aamsEventDate, aamsEventInfo.aamsEventDate) &&
        Objects.equals(this.intEventDate, aamsEventInfo.intEventDate) &&
        Objects.equals(this.operatorId, aamsEventInfo.operatorId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(operatorName, intEventId, extEventId, eventName, processedStatus, processedStatusName, processedMessage, eventType, registeredEventId, aamsEventDate, intEventDate, operatorId);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AamsEventInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AamsEventInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AamsEventInfo is not found in the empty JSON string", AamsEventInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AamsEventInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AamsEventInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AamsEventInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AamsEventInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AamsEventInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AamsEventInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AamsEventInfo>() {
           @Override
           public void write(JsonWriter out, AamsEventInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AamsEventInfo read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AamsEventInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AamsEventInfo
  * @throws IOException if the JSON string is invalid with respect to AamsEventInfo
  */
  public static AamsEventInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AamsEventInfo.class);
  }

 /**
  * Convert an instance of AamsEventInfo to an JSON string
  *
  * @return JSON string
  */
