...
/**
 * SelectionGlobalTranslationItem
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-26T23:02:24.556418400+03:00[Europe/Moscow]")
public class SelectionGlobalTranslationItem {
  ...
  public SelectionGlobalTranslationItem() {
  }

  public SelectionGlobalTranslationItem languageName(String languageName) {
  ...
  **/
  ...
  public SelectionGlobalTranslationItem internalTranslation(String internalTranslation) {
  ...
  **/
  ...
  public SelectionGlobalTranslationItem internalDescription(String internalDescription) {
  ...
  **/
  ...
  public SelectionGlobalTranslationItem sportTranslation(String sportTranslation) {
  ...
  **/
  ...
  public SelectionGlobalTranslationItem sportDescription(String sportDescription) {
  ...
  **/
  ...
  public SelectionGlobalTranslationItem isUnfinished(Boolean isUnfinished) {
  ...
  **/
  ...
  public SelectionGlobalTranslationItem languageId(Integer languageId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SelectionGlobalTranslationItem selectionGlobalTranslationItem = (SelectionGlobalTranslationItem) o;
    return Objects.equals(this.languageName, selectionGlobalTranslationItem.languageName) &&
        Objects.equals(this.internalTranslation, selectionGlobalTranslationItem.internalTranslation) &&
        Objects.equals(this.internalDescription, selectionGlobalTranslationItem.internalDescription) &&
        Objects.equals(this.sportTranslation, selectionGlobalTranslationItem.sportTranslation) &&
        Objects.equals(this.sportDescription, selectionGlobalTranslationItem.sportDescription) &&
        Objects.equals(this.isUnfinished, selectionGlobalTranslationItem.isUnfinished) &&
        Objects.equals(this.languageId, selectionGlobalTranslationItem.languageId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(languageName, internalTranslation, internalDescription, sportTranslation, sportDescription, isUnfinished, languageId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SelectionGlobalTranslationItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SelectionGlobalTranslationItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SelectionGlobalTranslationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SelectionGlobalTranslationItem is not found in the empty JSON string", SelectionGlobalTranslationItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SelectionGlobalTranslationItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SelectionGlobalTranslationItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelectionGlobalTranslationItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelectionGlobalTranslationItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelectionGlobalTranslationItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelectionGlobalTranslationItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SelectionGlobalTranslationItem>() {
           @Override
           public void write(JsonWriter out, SelectionGlobalTranslationItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SelectionGlobalTranslationItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SelectionGlobalTranslationItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelectionGlobalTranslationItem
  * @throws IOException if the JSON string is invalid with respect to SelectionGlobalTranslationItem
  */
  public static SelectionGlobalTranslationItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelectionGlobalTranslationItem.class);
  }

 /**
  * Convert an instance of SelectionGlobalTranslationItem to an JSON string
  *
  * @return JSON string
  */
