...
/**
 * GetCompetitorsRequestFilters
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-26T23:02:24.556418400+03:00[Europe/Moscow]")
public class GetCompetitorsRequestFilters {
  ...
  public GetCompetitorsRequestFilters() {
  }

  public GetCompetitorsRequestFilters categoriesIds(List<Integer> categoriesIds) {
    this.categoriesIds = categoriesIds;
    return this;
  }

  public GetCompetitorsRequestFilters addCategoriesIdsItem(Integer categoriesIdsItem) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters championshipsIds(List<Integer> championshipsIds) {
    this.championshipsIds = championshipsIds;
    return this;
  }

  public GetCompetitorsRequestFilters addChampionshipsIdsItem(Integer championshipsIdsItem) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters U18(Boolean U18) {
    this.U18 = U18;
    return this;
  }
  ...
  **/
  ...
  public GetCompetitorsRequestFilters noJersey(Boolean noJersey) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters noBirthdate(Boolean noBirthdate) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GetCompetitorsRequestFilters name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GetCompetitorsRequestFilters sportName(String sportName) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters birthdateFrom(OffsetDateTime birthdateFrom) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters birthdateTo(OffsetDateTime birthdateTo) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters birthdayStatuses(List<Integer> birthdayStatuses) {
    this.birthdayStatuses = birthdayStatuses;
    return this;
  }

  public GetCompetitorsRequestFilters addBirthdayStatusesItem(Integer birthdayStatusesItem) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters countryCode(String countryCode) {
  ...
  **/
  ...
  public GetCompetitorsRequestFilters sportsIds(List<Integer> sportsIds) {
    this.sportsIds = sportsIds;
    return this;
  }

  public GetCompetitorsRequestFilters addSportsIdsItem(Integer sportsIdsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetCompetitorsRequestFilters getCompetitorsRequestFilters = (GetCompetitorsRequestFilters) o;
    return Objects.equals(this.categoriesIds, getCompetitorsRequestFilters.categoriesIds) &&
        Objects.equals(this.championshipsIds, getCompetitorsRequestFilters.championshipsIds) &&
        Objects.equals(this.U18, getCompetitorsRequestFilters.U18) &&
        Objects.equals(this.noJersey, getCompetitorsRequestFilters.noJersey) &&
        Objects.equals(this.noBirthdate, getCompetitorsRequestFilters.noBirthdate) &&
        Objects.equals(this.id, getCompetitorsRequestFilters.id) &&
        Objects.equals(this.name, getCompetitorsRequestFilters.name) &&
        Objects.equals(this.sportName, getCompetitorsRequestFilters.sportName) &&
        Objects.equals(this.birthdateFrom, getCompetitorsRequestFilters.birthdateFrom) &&
        Objects.equals(this.birthdateTo, getCompetitorsRequestFilters.birthdateTo) &&
        Objects.equals(this.birthdayStatuses, getCompetitorsRequestFilters.birthdayStatuses) &&
        Objects.equals(this.countryCode, getCompetitorsRequestFilters.countryCode) &&
        Objects.equals(this.sportsIds, getCompetitorsRequestFilters.sportsIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCompetitorsRequestFilters {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetCompetitorsRequestFilters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCompetitorsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCompetitorsRequestFilters is not found in the empty JSON string", GetCompetitorsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCompetitorsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCompetitorsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCompetitorsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCompetitorsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCompetitorsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCompetitorsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCompetitorsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetCompetitorsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCompetitorsRequestFilters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetCompetitorsRequestFilters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetCompetitorsRequestFilters
  * @throws IOException if the JSON string is invalid with respect to GetCompetitorsRequestFilters
  */
  public static GetCompetitorsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCompetitorsRequestFilters.class);
  }

 /**
  * Convert an instance of GetCompetitorsRequestFilters to an JSON string
  *
  * @return JSON string
  */
