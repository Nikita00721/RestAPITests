...
/**
 * GetOutrightsRequestFilters
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-26T23:02:24.556418400+03:00[Europe/Moscow]")
public class GetOutrightsRequestFilters {
  ...
  public GetOutrightsRequestFilters() {
  }

  public GetOutrightsRequestFilters dateFrom(OffsetDateTime dateFrom) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters dateTo(OffsetDateTime dateTo) {
    this.dateTo = dateTo;
    return this;
  }
  ...
  **/
  ...
  public GetOutrightsRequestFilters eventProductsType(EventLiveTypes eventProductsType) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters customEventStatus(CustomEventStatuses customEventStatus) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters feedProviderIds(List<Integer> feedProviderIds) {
    this.feedProviderIds = feedProviderIds;
    return this;
  }

  public GetOutrightsRequestFilters addFeedProviderIdsItem(Integer feedProviderIdsItem) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters sportsIds(List<Integer> sportsIds) {
    this.sportsIds = sportsIds;
    return this;
  }

  public GetOutrightsRequestFilters addSportsIdsItem(Integer sportsIdsItem) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters categoriesIds(List<Integer> categoriesIds) {
    this.categoriesIds = categoriesIds;
    return this;
  }

  public GetOutrightsRequestFilters addCategoriesIdsItem(Integer categoriesIdsItem) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters championshipsIds(List<Integer> championshipsIds) {
    this.championshipsIds = championshipsIds;
    return this;
  }

  public GetOutrightsRequestFilters addChampionshipsIdsItem(Integer championshipsIdsItem) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters isPendingCancels(Boolean isPendingCancels) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters isOnlySelectedProviders(Boolean isOnlySelectedProviders) {
  ...
  **/
  ...
  public GetOutrightsRequestFilters searchString(String searchString) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetOutrightsRequestFilters getOutrightsRequestFilters = (GetOutrightsRequestFilters) o;
    return Objects.equals(this.dateFrom, getOutrightsRequestFilters.dateFrom) &&
        Objects.equals(this.dateTo, getOutrightsRequestFilters.dateTo) &&
        Objects.equals(this.eventProductsType, getOutrightsRequestFilters.eventProductsType) &&
        Objects.equals(this.customEventStatus, getOutrightsRequestFilters.customEventStatus) &&
        Objects.equals(this.feedProviderIds, getOutrightsRequestFilters.feedProviderIds) &&
        Objects.equals(this.sportsIds, getOutrightsRequestFilters.sportsIds) &&
        Objects.equals(this.categoriesIds, getOutrightsRequestFilters.categoriesIds) &&
        Objects.equals(this.championshipsIds, getOutrightsRequestFilters.championshipsIds) &&
        Objects.equals(this.isPendingCancels, getOutrightsRequestFilters.isPendingCancels) &&
        Objects.equals(this.isOnlySelectedProviders, getOutrightsRequestFilters.isOnlySelectedProviders) &&
        Objects.equals(this.searchString, getOutrightsRequestFilters.searchString);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOutrightsRequestFilters {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetOutrightsRequestFilters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOutrightsRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOutrightsRequestFilters is not found in the empty JSON string", GetOutrightsRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOutrightsRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOutrightsRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOutrightsRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOutrightsRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOutrightsRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOutrightsRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOutrightsRequestFilters>() {
           @Override
           public void write(JsonWriter out, GetOutrightsRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOutrightsRequestFilters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetOutrightsRequestFilters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetOutrightsRequestFilters
  * @throws IOException if the JSON string is invalid with respect to GetOutrightsRequestFilters
  */
  public static GetOutrightsRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOutrightsRequestFilters.class);
  }

 /**
  * Convert an instance of GetOutrightsRequestFilters to an JSON string
  *
  * @return JSON string
  */
