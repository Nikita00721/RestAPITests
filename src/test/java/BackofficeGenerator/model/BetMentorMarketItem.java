...
public class BetMentorMarketItem {
  ...
  public BetMentorMarketItem() {
  }

  public BetMentorMarketItem marketTypeName(String marketTypeName) {
  ...
  **/
  ...
  public BetMentorMarketItem specialOddsTypeId(Integer specialOddsTypeId) {
  ...
  **/
  ...
  public BetMentorMarketItem specialOddsValue(String specialOddsValue) {
  ...
  **/
  ...
  public BetMentorMarketItem useMostBalanced(Boolean useMostBalanced) {
  ...
  **/
  ...
  public BetMentorMarketItem marketTypeId(Integer marketTypeId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BetMentorMarketItem betMentorMarketItem = (BetMentorMarketItem) o;
    return Objects.equals(this.marketTypeName, betMentorMarketItem.marketTypeName) &&
        Objects.equals(this.specialOddsTypeId, betMentorMarketItem.specialOddsTypeId) &&
        Objects.equals(this.specialOddsValue, betMentorMarketItem.specialOddsValue) &&
        Objects.equals(this.useMostBalanced, betMentorMarketItem.useMostBalanced) &&
        Objects.equals(this.marketTypeId, betMentorMarketItem.marketTypeId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(marketTypeName, specialOddsTypeId, specialOddsValue, useMostBalanced, marketTypeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class BetMentorMarketItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BetMentorMarketItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BetMentorMarketItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BetMentorMarketItem is not found in the empty JSON string", BetMentorMarketItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BetMentorMarketItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BetMentorMarketItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BetMentorMarketItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BetMentorMarketItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BetMentorMarketItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BetMentorMarketItem.class));

       return (TypeAdapter<T>) new TypeAdapter<BetMentorMarketItem>() {
           @Override
           public void write(JsonWriter out, BetMentorMarketItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BetMentorMarketItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BetMentorMarketItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BetMentorMarketItem
  * @throws IOException if the JSON string is invalid with respect to BetMentorMarketItem
  */
  public static BetMentorMarketItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BetMentorMarketItem.class);
  }

 /**
  * Convert an instance of BetMentorMarketItem to an JSON string
  *
  * @return JSON string
  */
