...
/**
 * PlayerListRequestFilter
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-26T23:02:24.556418400+03:00[Europe/Moscow]")
public class PlayerListRequestFilter {
  ...
  public static final String SERIALIZED_NAME_WITH_TOTALS = "WithTotals";
  @SerializedName(SERIALIZED_NAME_WITH_TOTALS)
  ...
  public PlayerListRequestFilter() {
  }

  public PlayerListRequestFilter extPlayerId(String extPlayerId) {
  ...
  **/
  ...
  public PlayerListRequestFilter searchName(String searchName) {
  ...
  **/
  ...
  public PlayerListRequestFilter dateFrom(OffsetDateTime dateFrom) {
  ...
  **/
  ...
  public PlayerListRequestFilter dateTo(OffsetDateTime dateTo) {
    this.dateTo = dateTo;
    return this;
  }
  ...
  **/
  ...
  public PlayerListRequestFilter colors(List<String> colors) {
    this.colors = colors;
    return this;
  }

  public PlayerListRequestFilter addColorsItem(String colorsItem) {
    if (this.colors == null) {
  ...
  **/
  ...
  public PlayerListRequestFilter limitGroupIds(List<Integer> limitGroupIds) {
    this.limitGroupIds = limitGroupIds;
    return this;
  }

  public PlayerListRequestFilter addLimitGroupIdsItem(Integer limitGroupIdsItem) {
  ...
  **/
  ...
  public PlayerListRequestFilter affiliatesIds(List<Integer> affiliatesIds) {
    this.affiliatesIds = affiliatesIds;
    return this;
  }

  public PlayerListRequestFilter addAffiliatesIdsItem(Integer affiliatesIdsItem) {
  ...
  **/
  ...
  public PlayerListRequestFilter brandsIds(List<Integer> brandsIds) {
    this.brandsIds = brandsIds;
    return this;
  }

  public PlayerListRequestFilter addBrandsIdsItem(Integer brandsIdsItem) {
  ...
  **/
  ...
  public PlayerListRequestFilter licensesIds(List<Integer> licensesIds) {
    this.licensesIds = licensesIds;
    return this;
  }

  public PlayerListRequestFilter addLicensesIdsItem(Integer licensesIdsItem) {
  ...
  **/
  ...
  public PlayerListRequestFilter sortDesc(Boolean sortDesc) {
  ...
  **/
  ...
  public PlayerListRequestFilter withTotals(Boolean withTotals) {
  ...
  **/
  ...
  public PlayerListRequestFilter intPlayerId(Integer intPlayerId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PlayerListRequestFilter playerListRequestFilter = (PlayerListRequestFilter) o;
    return Objects.equals(this.extPlayerId, playerListRequestFilter.extPlayerId) &&
        Objects.equals(this.searchName, playerListRequestFilter.searchName) &&
        Objects.equals(this.dateFrom, playerListRequestFilter.dateFrom) &&
        Objects.equals(this.dateTo, playerListRequestFilter.dateTo) &&
        Objects.equals(this.colors, playerListRequestFilter.colors) &&
        Objects.equals(this.limitGroupIds, playerListRequestFilter.limitGroupIds) &&
        Objects.equals(this.affiliatesIds, playerListRequestFilter.affiliatesIds) &&
        Objects.equals(this.brandsIds, playerListRequestFilter.brandsIds) &&
        Objects.equals(this.licensesIds, playerListRequestFilter.licensesIds) &&
        Objects.equals(this.sortDesc, playerListRequestFilter.sortDesc) &&
        Objects.equals(this.withTotals, playerListRequestFilter.withTotals) &&
        Objects.equals(this.intPlayerId, playerListRequestFilter.intPlayerId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(extPlayerId, searchName, dateFrom, dateTo, colors, limitGroupIds, affiliatesIds, brandsIds, licensesIds, sortDesc, withTotals, intPlayerId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlayerListRequestFilter {\n");
    ...
    sb.append("    withTotals: ").append(toIndentedString(withTotals)).append("\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to PlayerListRequestFilter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlayerListRequestFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlayerListRequestFilter is not found in the empty JSON string", PlayerListRequestFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlayerListRequestFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlayerListRequestFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlayerListRequestFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlayerListRequestFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlayerListRequestFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlayerListRequestFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<PlayerListRequestFilter>() {
           @Override
           public void write(JsonWriter out, PlayerListRequestFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlayerListRequestFilter read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PlayerListRequestFilter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PlayerListRequestFilter
  * @throws IOException if the JSON string is invalid with respect to PlayerListRequestFilter
  */
  public static PlayerListRequestFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlayerListRequestFilter.class);
  }

 /**
  * Convert an instance of PlayerListRequestFilter to an JSON string
  *
  * @return JSON string
  */
