...
public class GetEventsResults {
  ...
  public GetEventsResults events(List<SportEvent> events) {
    this.events = events;
    return this;
  }

  public GetEventsResults addEventsItem(SportEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetEventsResults headers(List<Header> headers) {
    this.headers = headers;
    return this;
  }

  public GetEventsResults addHeadersItem(Header headersItem) {
  ...
  **/
  ...
  public GetEventsResults topSports(List<TopSport> topSports) {
    this.topSports = topSports;
    return this;
  }

  public GetEventsResults addTopSportsItem(TopSport topSportsItem) {
  ...
  **/
  ...
  public GetEventsResults dates(List<EventsByDate> dates) {
    this.dates = dates;
    return this;
  }

  public GetEventsResults addDatesItem(EventsByDate datesItem) {
    if (this.dates == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetEventsResults getEventsResults = (GetEventsResults) o;
    return Objects.equals(this.events, getEventsResults.events) &&
        Objects.equals(this.sports, getEventsResults.sports) &&
        Objects.equals(this.categories, getEventsResults.categories) &&
        Objects.equals(this.champs, getEventsResults.champs) &&
        Objects.equals(this.competitors, getEventsResults.competitors) &&
        Objects.equals(this.markets, getEventsResults.markets) &&
        Objects.equals(this.odds, getEventsResults.odds) &&
        Objects.equals(this.headers, getEventsResults.headers) &&
        Objects.equals(this.topSports, getEventsResults.topSports) &&
        Objects.equals(this.dates, getEventsResults.dates);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEventsResults is not found in the empty JSON string", GetEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetEventsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEventsResults>() {
           @Override
           public void write(JsonWriter out, GetEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetEventsResults
  */
  public static GetEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEventsResults.class);
  }

 /**
  * Convert an instance of GetEventsResults to an JSON string
  *
  * @return JSON string
  */
