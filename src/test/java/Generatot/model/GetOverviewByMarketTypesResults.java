...
/**
 * GetOverviewByMarketTypesResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetOverviewByMarketTypesResults {
  ...
  public GetOverviewByMarketTypesResults() {
  }

  public GetOverviewByMarketTypesResults events(List<SportEvent> events) {
    this.events = events;
    return this;
  }

  public GetOverviewByMarketTypesResults addEventsItem(SportEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetOverviewByMarketTypesResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetOverviewByMarketTypesResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetOverviewByMarketTypesResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetOverviewByMarketTypesResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetOverviewByMarketTypesResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetOverviewByMarketTypesResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults headers(List<Header> headers) {
    this.headers = headers;
    return this;
  }

  public GetOverviewByMarketTypesResults addHeadersItem(Header headersItem) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults topSports(List<TopSport> topSports) {
    this.topSports = topSports;
    return this;
  }

  public GetOverviewByMarketTypesResults addTopSportsItem(TopSport topSportsItem) {
  ...
  **/
  ...
  public GetOverviewByMarketTypesResults dates(List<EventsByDate> dates) {
    this.dates = dates;
    return this;
  }

  public GetOverviewByMarketTypesResults addDatesItem(EventsByDate datesItem) {
    if (this.dates == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetOverviewByMarketTypesResults getOverviewByMarketTypesResults = (GetOverviewByMarketTypesResults) o;
    return Objects.equals(this.events, getOverviewByMarketTypesResults.events) &&
        Objects.equals(this.sports, getOverviewByMarketTypesResults.sports) &&
        Objects.equals(this.categories, getOverviewByMarketTypesResults.categories) &&
        Objects.equals(this.champs, getOverviewByMarketTypesResults.champs) &&
        Objects.equals(this.competitors, getOverviewByMarketTypesResults.competitors) &&
        Objects.equals(this.markets, getOverviewByMarketTypesResults.markets) &&
        Objects.equals(this.odds, getOverviewByMarketTypesResults.odds) &&
        Objects.equals(this.headers, getOverviewByMarketTypesResults.headers) &&
        Objects.equals(this.topSports, getOverviewByMarketTypesResults.topSports) &&
        Objects.equals(this.dates, getOverviewByMarketTypesResults.dates);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetOverviewByMarketTypesResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetOverviewByMarketTypesResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOverviewByMarketTypesResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOverviewByMarketTypesResults is not found in the empty JSON string", GetOverviewByMarketTypesResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOverviewByMarketTypesResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOverviewByMarketTypesResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetOverviewByMarketTypesResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOverviewByMarketTypesResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOverviewByMarketTypesResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOverviewByMarketTypesResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOverviewByMarketTypesResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOverviewByMarketTypesResults>() {
           @Override
           public void write(JsonWriter out, GetOverviewByMarketTypesResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOverviewByMarketTypesResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetOverviewByMarketTypesResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetOverviewByMarketTypesResults
  * @throws IOException if the JSON string is invalid with respect to GetOverviewByMarketTypesResults
  */
  public static GetOverviewByMarketTypesResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOverviewByMarketTypesResults.class);
  }

 /**
  * Convert an instance of GetOverviewByMarketTypesResults to an JSON string
  *
  * @return JSON string
  */
