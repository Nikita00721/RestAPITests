...
public class GetEventCardResults {
  ...
  public GetEventCardResults() {
  }

  public GetEventCardResults events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public GetEventCardResults addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetEventCardResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetEventCardResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetEventCardResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetEventCardResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetEventCardResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetEventCardResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetEventCardResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetEventCardResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetEventCardResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetEventCardResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetEventCardResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetEventCardResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetEventCardResults getEventCardResults = (GetEventCardResults) o;
    return Objects.equals(this.events, getEventCardResults.events) &&
        Objects.equals(this.sports, getEventCardResults.sports) &&
        Objects.equals(this.categories, getEventCardResults.categories) &&
        Objects.equals(this.champs, getEventCardResults.champs) &&
        Objects.equals(this.competitors, getEventCardResults.competitors) &&
        Objects.equals(this.markets, getEventCardResults.markets) &&
        Objects.equals(this.odds, getEventCardResults.odds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEventCardResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetEventCardResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEventCardResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEventCardResults is not found in the empty JSON string", GetEventCardResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEventCardResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEventCardResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetEventCardResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEventCardResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEventCardResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEventCardResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEventCardResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEventCardResults>() {
           @Override
           public void write(JsonWriter out, GetEventCardResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEventCardResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetEventCardResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetEventCardResults
  * @throws IOException if the JSON string is invalid with respect to GetEventCardResults
  */
  public static GetEventCardResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEventCardResults.class);
  }

 /**
  * Convert an instance of GetEventCardResults to an JSON string
  *
  * @return JSON string
  */
