...
/**
 * GetLiveEventsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetLiveEventsResults {
  ...
  public GetLiveEventsResults() {
  }

  public GetLiveEventsResults events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public GetLiveEventsResults addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetLiveEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetLiveEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetLiveEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetLiveEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetLiveEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetLiveEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetLiveEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetLiveEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetLiveEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetLiveEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetLiveEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetLiveEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetLiveEventsResults headers(List<Header> headers) {
    this.headers = headers;
    return this;
  }

  public GetLiveEventsResults addHeadersItem(Header headersItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetLiveEventsResults getLiveEventsResults = (GetLiveEventsResults) o;
    return Objects.equals(this.events, getLiveEventsResults.events) &&
        Objects.equals(this.sports, getLiveEventsResults.sports) &&
        Objects.equals(this.categories, getLiveEventsResults.categories) &&
        Objects.equals(this.champs, getLiveEventsResults.champs) &&
        Objects.equals(this.competitors, getLiveEventsResults.competitors) &&
        Objects.equals(this.markets, getLiveEventsResults.markets) &&
        Objects.equals(this.odds, getLiveEventsResults.odds) &&
        Objects.equals(this.headers, getLiveEventsResults.headers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(events, sports, categories, champs, competitors, markets, odds, headers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetLiveEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetLiveEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLiveEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLiveEventsResults is not found in the empty JSON string", GetLiveEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLiveEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLiveEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetLiveEventsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLiveEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLiveEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLiveEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLiveEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLiveEventsResults>() {
           @Override
           public void write(JsonWriter out, GetLiveEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLiveEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetLiveEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLiveEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetLiveEventsResults
  */
  public static GetLiveEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLiveEventsResults.class);
  }

 /**
  * Convert an instance of GetLiveEventsResults to an JSON string
  *
  * @return JSON string
  */
