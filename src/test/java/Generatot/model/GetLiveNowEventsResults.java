...
/**
 * GetLiveNowEventsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetLiveNowEventsResults {
  ...
  public GetLiveNowEventsResults() {
  }

  public GetLiveNowEventsResults events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public GetLiveNowEventsResults addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetLiveNowEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetLiveNowEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetLiveNowEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetLiveNowEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetLiveNowEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetLiveNowEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetLiveNowEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetLiveNowEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetLiveNowEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetLiveNowEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetLiveNowEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetLiveNowEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetLiveNowEventsResults headers(List<Header> headers) {
    this.headers = headers;
    return this;
  }

  public GetLiveNowEventsResults addHeadersItem(Header headersItem) {
  ...
  **/
  ...
  public GetLiveNowEventsResults topSports(List<TopSport> topSports) {
    this.topSports = topSports;
    return this;
  }

  public GetLiveNowEventsResults addTopSportsItem(TopSport topSportsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetLiveNowEventsResults getLiveNowEventsResults = (GetLiveNowEventsResults) o;
    return Objects.equals(this.events, getLiveNowEventsResults.events) &&
        Objects.equals(this.sports, getLiveNowEventsResults.sports) &&
        Objects.equals(this.categories, getLiveNowEventsResults.categories) &&
        Objects.equals(this.champs, getLiveNowEventsResults.champs) &&
        Objects.equals(this.competitors, getLiveNowEventsResults.competitors) &&
        Objects.equals(this.markets, getLiveNowEventsResults.markets) &&
        Objects.equals(this.odds, getLiveNowEventsResults.odds) &&
        Objects.equals(this.headers, getLiveNowEventsResults.headers) &&
        Objects.equals(this.topSports, getLiveNowEventsResults.topSports);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLiveNowEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetLiveNowEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLiveNowEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLiveNowEventsResults is not found in the empty JSON string", GetLiveNowEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLiveNowEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLiveNowEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetLiveNowEventsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLiveNowEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLiveNowEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLiveNowEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLiveNowEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLiveNowEventsResults>() {
           @Override
           public void write(JsonWriter out, GetLiveNowEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLiveNowEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetLiveNowEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetLiveNowEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetLiveNowEventsResults
  */
  public static GetLiveNowEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLiveNowEventsResults.class);
  }

 /**
  * Convert an instance of GetLiveNowEventsResults to an JSON string
  *
  * @return JSON string
  */
