...
/**
 * GetPTopEventsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetPTopEventsResults {
  ...
  public GetPTopEventsResults() {
  }

  public GetPTopEventsResults events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public GetPTopEventsResults addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetPTopEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetPTopEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetPTopEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetPTopEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetPTopEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetPTopEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetPTopEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetPTopEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetPTopEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetPTopEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetPTopEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetPTopEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetPTopEventsResults getPTopEventsResults = (GetPTopEventsResults) o;
    return Objects.equals(this.events, getPTopEventsResults.events) &&
        Objects.equals(this.sports, getPTopEventsResults.sports) &&
        Objects.equals(this.categories, getPTopEventsResults.categories) &&
        Objects.equals(this.champs, getPTopEventsResults.champs) &&
        Objects.equals(this.competitors, getPTopEventsResults.competitors) &&
        Objects.equals(this.markets, getPTopEventsResults.markets) &&
        Objects.equals(this.odds, getPTopEventsResults.odds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPTopEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetPTopEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPTopEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPTopEventsResults is not found in the empty JSON string", GetPTopEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPTopEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPTopEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPTopEventsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPTopEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPTopEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPTopEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPTopEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPTopEventsResults>() {
           @Override
           public void write(JsonWriter out, GetPTopEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPTopEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetPTopEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetPTopEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetPTopEventsResults
  */
  public static GetPTopEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPTopEventsResults.class);
  }

 /**
  * Convert an instance of GetPTopEventsResults to an JSON string
  *
  * @return JSON string
  */
