...
public class SearchResults {
  ...
  public SearchResults events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public SearchResults addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public SearchResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public SearchResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public SearchResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public SearchResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public SearchResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public SearchResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public SearchResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public SearchResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public SearchResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public SearchResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public SearchResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public SearchResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public SearchResults result(SearchResult result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.events, searchResults.events) &&
        Objects.equals(this.sports, searchResults.sports) &&
        Objects.equals(this.categories, searchResults.categories) &&
        Objects.equals(this.champs, searchResults.champs) &&
        Objects.equals(this.competitors, searchResults.competitors) &&
        Objects.equals(this.markets, searchResults.markets) &&
        Objects.equals(this.odds, searchResults.odds) &&
        Objects.equals(this.result, searchResults.result);
  }

  @Override
  public int hashCode() {
    return Objects.hash(events, sports, categories, champs, competitors, markets, odds, result);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Result") != null && !jsonObj.get("Result").isJsonNull()) {
        SearchResult.validateJsonElement(jsonObj.get("Result"));
      }
  }
