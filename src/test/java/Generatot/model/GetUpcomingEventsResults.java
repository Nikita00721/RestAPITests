...
/**
 * GetUpcomingEventsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetUpcomingEventsResults {
  ...
  public GetUpcomingEventsResults() {
  }

  public GetUpcomingEventsResults events(List<SportEvent> events) {
    this.events = events;
    return this;
  }

  public GetUpcomingEventsResults addEventsItem(SportEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetUpcomingEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetUpcomingEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetUpcomingEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetUpcomingEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetUpcomingEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetUpcomingEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetUpcomingEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetUpcomingEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetUpcomingEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetUpcomingEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetUpcomingEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetUpcomingEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetUpcomingEventsResults headers(List<Header> headers) {
    this.headers = headers;
    return this;
  }

  public GetUpcomingEventsResults addHeadersItem(Header headersItem) {
  ...
  **/
  ...
  public GetUpcomingEventsResults topSports(List<TopSport> topSports) {
    this.topSports = topSports;
    return this;
  }

  public GetUpcomingEventsResults addTopSportsItem(TopSport topSportsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetUpcomingEventsResults getUpcomingEventsResults = (GetUpcomingEventsResults) o;
    return Objects.equals(this.events, getUpcomingEventsResults.events) &&
        Objects.equals(this.sports, getUpcomingEventsResults.sports) &&
        Objects.equals(this.categories, getUpcomingEventsResults.categories) &&
        Objects.equals(this.champs, getUpcomingEventsResults.champs) &&
        Objects.equals(this.competitors, getUpcomingEventsResults.competitors) &&
        Objects.equals(this.markets, getUpcomingEventsResults.markets) &&
        Objects.equals(this.odds, getUpcomingEventsResults.odds) &&
        Objects.equals(this.headers, getUpcomingEventsResults.headers) &&
        Objects.equals(this.topSports, getUpcomingEventsResults.topSports);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUpcomingEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetUpcomingEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUpcomingEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUpcomingEventsResults is not found in the empty JSON string", GetUpcomingEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUpcomingEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUpcomingEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUpcomingEventsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUpcomingEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUpcomingEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUpcomingEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUpcomingEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUpcomingEventsResults>() {
           @Override
           public void write(JsonWriter out, GetUpcomingEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUpcomingEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetUpcomingEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetUpcomingEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetUpcomingEventsResults
  */
  public static GetUpcomingEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUpcomingEventsResults.class);
  }

 /**
  * Convert an instance of GetUpcomingEventsResults to an JSON string
  *
  * @return JSON string
  */
