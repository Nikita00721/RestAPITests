...
/**
 * GetHighlightEventsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetHighlightEventsResults {
  ...
  public GetHighlightEventsResults() {
  }

  public GetHighlightEventsResults events(List<SportEvent> events) {
    this.events = events;
    return this;
  }

  public GetHighlightEventsResults addEventsItem(SportEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetHighlightEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetHighlightEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetHighlightEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetHighlightEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetHighlightEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetHighlightEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetHighlightEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetHighlightEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetHighlightEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetHighlightEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetHighlightEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetHighlightEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetHighlightEventsResults headers(List<Header> headers) {
    this.headers = headers;
    return this;
  }

  public GetHighlightEventsResults addHeadersItem(Header headersItem) {
  ...
  **/
  ...
  public GetHighlightEventsResults topSports(List<TopSport> topSports) {
    this.topSports = topSports;
    return this;
  }

  public GetHighlightEventsResults addTopSportsItem(TopSport topSportsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetHighlightEventsResults getHighlightEventsResults = (GetHighlightEventsResults) o;
    return Objects.equals(this.events, getHighlightEventsResults.events) &&
        Objects.equals(this.sports, getHighlightEventsResults.sports) &&
        Objects.equals(this.categories, getHighlightEventsResults.categories) &&
        Objects.equals(this.champs, getHighlightEventsResults.champs) &&
        Objects.equals(this.competitors, getHighlightEventsResults.competitors) &&
        Objects.equals(this.markets, getHighlightEventsResults.markets) &&
        Objects.equals(this.odds, getHighlightEventsResults.odds) &&
        Objects.equals(this.headers, getHighlightEventsResults.headers) &&
        Objects.equals(this.topSports, getHighlightEventsResults.topSports);
  }

  @Override
  public int hashCode() {
    return Objects.hash(events, sports, categories, champs, competitors, markets, odds, headers, topSports);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetHighlightEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetHighlightEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetHighlightEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetHighlightEventsResults is not found in the empty JSON string", GetHighlightEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetHighlightEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetHighlightEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetHighlightEventsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetHighlightEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetHighlightEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetHighlightEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetHighlightEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetHighlightEventsResults>() {
           @Override
           public void write(JsonWriter out, GetHighlightEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetHighlightEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetHighlightEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetHighlightEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetHighlightEventsResults
  */
  public static GetHighlightEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetHighlightEventsResults.class);
  }

 /**
  * Convert an instance of GetHighlightEventsResults to an JSON string
  *
  * @return JSON string
  */
