...
/**
 * GetEventsByOddsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetEventsByOddsResults {
  ...
  public GetEventsByOddsResults() {
  }

  public GetEventsByOddsResults events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public GetEventsByOddsResults addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetEventsByOddsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetEventsByOddsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetEventsByOddsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetEventsByOddsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetEventsByOddsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetEventsByOddsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetEventsByOddsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetEventsByOddsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetEventsByOddsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetEventsByOddsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetEventsByOddsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetEventsByOddsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetEventsByOddsResults getEventsByOddsResults = (GetEventsByOddsResults) o;
    return Objects.equals(this.events, getEventsByOddsResults.events) &&
        Objects.equals(this.sports, getEventsByOddsResults.sports) &&
        Objects.equals(this.categories, getEventsByOddsResults.categories) &&
        Objects.equals(this.champs, getEventsByOddsResults.champs) &&
        Objects.equals(this.competitors, getEventsByOddsResults.competitors) &&
        Objects.equals(this.markets, getEventsByOddsResults.markets) &&
        Objects.equals(this.odds, getEventsByOddsResults.odds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEventsByOddsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetEventsByOddsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEventsByOddsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEventsByOddsResults is not found in the empty JSON string", GetEventsByOddsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEventsByOddsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEventsByOddsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetEventsByOddsResults.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEventsByOddsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEventsByOddsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEventsByOddsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEventsByOddsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEventsByOddsResults>() {
           @Override
           public void write(JsonWriter out, GetEventsByOddsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEventsByOddsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetEventsByOddsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetEventsByOddsResults
  * @throws IOException if the JSON string is invalid with respect to GetEventsByOddsResults
  */
  public static GetEventsByOddsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEventsByOddsResults.class);
  }

 /**
  * Convert an instance of GetEventsByOddsResults to an JSON string
  *
  * @return JSON string
  */
