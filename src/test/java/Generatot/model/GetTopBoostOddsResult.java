...
/**
 * GetTopBoostOddsResult
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetTopBoostOddsResult {
  ...
  public GetTopBoostOddsResult() {
  }

  public GetTopBoostOddsResult events(List<LiveEvent> events) {
    this.events = events;
    return this;
  }

  public GetTopBoostOddsResult addEventsItem(LiveEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public GetTopBoostOddsResult sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetTopBoostOddsResult addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetTopBoostOddsResult categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetTopBoostOddsResult addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetTopBoostOddsResult champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetTopBoostOddsResult addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetTopBoostOddsResult competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetTopBoostOddsResult addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetTopBoostOddsResult markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetTopBoostOddsResult addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetTopBoostOddsResult odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetTopBoostOddsResult addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetTopBoostOddsResult getTopBoostOddsResult = (GetTopBoostOddsResult) o;
    return Objects.equals(this.events, getTopBoostOddsResult.events) &&
        Objects.equals(this.sports, getTopBoostOddsResult.sports) &&
        Objects.equals(this.categories, getTopBoostOddsResult.categories) &&
        Objects.equals(this.champs, getTopBoostOddsResult.champs) &&
        Objects.equals(this.competitors, getTopBoostOddsResult.competitors) &&
        Objects.equals(this.markets, getTopBoostOddsResult.markets) &&
        Objects.equals(this.odds, getTopBoostOddsResult.odds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTopBoostOddsResult {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetTopBoostOddsResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTopBoostOddsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTopBoostOddsResult is not found in the empty JSON string", GetTopBoostOddsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTopBoostOddsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTopBoostOddsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTopBoostOddsResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTopBoostOddsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTopBoostOddsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTopBoostOddsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTopBoostOddsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTopBoostOddsResult>() {
           @Override
           public void write(JsonWriter out, GetTopBoostOddsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTopBoostOddsResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetTopBoostOddsResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTopBoostOddsResult
  * @throws IOException if the JSON string is invalid with respect to GetTopBoostOddsResult
  */
  public static GetTopBoostOddsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTopBoostOddsResult.class);
  }

 /**
  * Convert an instance of GetTopBoostOddsResult to an JSON string
  *
  * @return JSON string
  */
