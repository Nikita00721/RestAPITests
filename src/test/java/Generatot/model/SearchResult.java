...
public class SearchResult {
  ...
  private List<InnerBMS> items = new ArrayList<>();
  ...
  public SearchResult items(List<InnerBMS> items) {
    this.items = items;
    return this;
  }

  public SearchResult addItemsItem(InnerBMS itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<InnerBMS> getItems() {
    return items;
  }

  public void setItems(List<InnerBMS> items) {
    this.items = items;
  }


  public SearchResult total(Double total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public SearchResult attempts(Integer attempts) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, searchResult.items) &&
        ...
        Objects.equals(this.attempts, searchResult.attempts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, total, attempts);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        InnerBMS.validateJsonElement(jsonArrayitems.get(i));
      };
  }
