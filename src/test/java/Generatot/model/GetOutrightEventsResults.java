...
/**
 * GetOutrightEventsResults
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T19:49:20.010092+03:00[Europe/Moscow]")
public class GetOutrightEventsResults {
  public static final String SERIALIZED_NAME_EVENTS = "Events";
  @SerializedName(SERIALIZED_NAME_EVENTS)
  private List<OutrightEvent> events = new ArrayList<>();
  ...
  public GetOutrightEventsResults() {
  }

  public GetOutrightEventsResults events(List<OutrightEvent> events) {
    this.events = events;
    return this;
  }

  public GetOutrightEventsResults addEventsItem(OutrightEvent eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public List<OutrightEvent> getEvents() {
    return events;
  }

  public void setEvents(List<OutrightEvent> events) {
    this.events = events;
  }


  public GetOutrightEventsResults sports(List<SportNodeWithChildIds> sports) {
    this.sports = sports;
    return this;
  }

  public GetOutrightEventsResults addSportsItem(SportNodeWithChildIds sportsItem) {
    if (this.sports == null) {
  ...
  **/
  ...
  public GetOutrightEventsResults categories(List<CategoryNodeWithChildIds> categories) {
    this.categories = categories;
    return this;
  }

  public GetOutrightEventsResults addCategoriesItem(CategoryNodeWithChildIds categoriesItem) {
  ...
  **/
  ...
  public GetOutrightEventsResults champs(List<ChampionshipNode> champs) {
    this.champs = champs;
    return this;
  }

  public GetOutrightEventsResults addChampsItem(ChampionshipNode champsItem) {
    if (this.champs == null) {
  ...
  **/
  ...
  public GetOutrightEventsResults competitors(List<Competitor> competitors) {
    this.competitors = competitors;
    return this;
  }

  public GetOutrightEventsResults addCompetitorsItem(Competitor competitorsItem) {
  ...
  **/
  ...
  public GetOutrightEventsResults markets(List<Market> markets) {
    this.markets = markets;
    return this;
  }

  public GetOutrightEventsResults addMarketsItem(Market marketsItem) {
  ...
  **/
  ...
  public GetOutrightEventsResults odds(List<Odd> odds) {
    this.odds = odds;
    return this;
  }

  public GetOutrightEventsResults addOddsItem(Odd oddsItem) {
    if (this.odds == null) {
  ...
  **/
  ...
  public GetOutrightEventsResults outrightGroups(List<OutrightGroupPerChamp> outrightGroups) {
    this.outrightGroups = outrightGroups;
    return this;
  }

  public GetOutrightEventsResults addOutrightGroupsItem(OutrightGroupPerChamp outrightGroupsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetOutrightEventsResults getOutrightEventsResults = (GetOutrightEventsResults) o;
    return Objects.equals(this.events, getOutrightEventsResults.events) &&
        Objects.equals(this.sports, getOutrightEventsResults.sports) &&
        Objects.equals(this.categories, getOutrightEventsResults.categories) &&
        Objects.equals(this.champs, getOutrightEventsResults.champs) &&
        Objects.equals(this.competitors, getOutrightEventsResults.competitors) &&
        Objects.equals(this.markets, getOutrightEventsResults.markets) &&
        Objects.equals(this.odds, getOutrightEventsResults.odds) &&
        Objects.equals(this.outrightGroups, getOutrightEventsResults.outrightGroups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(events, sports, categories, champs, competitors, markets, odds, outrightGroups);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetOutrightEventsResults {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetOutrightEventsResults
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOutrightEventsResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOutrightEventsResults is not found in the empty JSON string", GetOutrightEventsResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOutrightEventsResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOutrightEventsResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetOutrightEventsResults.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayevents.size(); i++) {
        OutrightEvent.validateJsonElement(jsonArrayevents.get(i));
      };
      // ensure the json data is an array
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOutrightEventsResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOutrightEventsResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOutrightEventsResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOutrightEventsResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOutrightEventsResults>() {
           @Override
           public void write(JsonWriter out, GetOutrightEventsResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOutrightEventsResults read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetOutrightEventsResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetOutrightEventsResults
  * @throws IOException if the JSON string is invalid with respect to GetOutrightEventsResults
  */
  public static GetOutrightEventsResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOutrightEventsResults.class);
  }

 /**
  * Convert an instance of GetOutrightEventsResults to an JSON string
  *
  * @return JSON string
  */
